...
// Shell de la app: semilla del layout IDE del doc 10 §4. Chat, Grafo, Memoria
// (doc 13 §4), Trazas (Sprint 19), Estado, y Métricas (doc 06 §2 addendum
// 2026-08-21).
type View = "chat" | "graph" | "memory" | "traces" | "status" | "metrics";
...
export default function App() {
  ...
  // Colapso del rail de vistas (doc 13 §3): sin default responsivo — el rail
  // arranca expandido a cualquier ancho, solo el usuario lo oculta.
  const [railCollapsed, setRailCollapsed] = useState(() =>
    getUiPref("railCollapsed", false),
  );
  ...
  return (
    <div className="flex h-screen">
      {railCollapsed ? (
        <div className="flex w-8 shrink-0 flex-col items-center border-r border-border py-3">
          <button
            type="button"
            onClick={toggleRail}
