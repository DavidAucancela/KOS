...
async def test_list_tools_expone_las_herramientas_registradas() -> None:
    """16 herramientas: las 13 del cierre de v1.0-Sprint 22 + `obsidian.read_note`/
    `update_note`/`create_folder` (deuda cerrada 2026-08-26, doc 06 §4).
    ...
    docs/deuda-tecnica.md) — por eso se actualiza en el momento en que se
    agrega una tool nueva, no después."""
